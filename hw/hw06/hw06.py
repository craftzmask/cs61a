...
class Coin:
    ...
    def worth(self):
        if Mint.present_year - self.year > 50:
            return Mint.present_year - self.year - 50 + self.cents
        return self.cents
...
class VendingMachine:
    ...
    def restock(self, quantity):
        ...
        return f'Current {self.product_name} stock: {self.quantity}'
...
class VirFib():
    ...
    def next(self):
        if self.value == 0:
            ...
            new_fib = VirFib(self.prev + self.value)
        new_fib.prev = self.value
        return new_fib
